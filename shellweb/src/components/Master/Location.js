...
const Location = () => {
  ...
  const fetchStates = async (countryId) => {
    const response = await axios.get(
      `${BASE_URL}/GetCountryWiseStateMaster/${countryId}`
    );
  ...
  const fetchCities = async (stateId) => {
    const response = await axios.get(
      `${BASE_URL}/GetCityWiseStateMaster/${stateId}`
    );
  ...
  async function bindState(cnCountryID) {
    const response = await axios.get(
      `${BASE_URL}/GetCountryWiseStateMaster/${cnCountryID}`
    );
    setStates(response.data);
  }
  async function bindCity(stStateID) {
    const response = await axios.get(
      `${BASE_URL}/GetCityWiseStateMaster/${stStateID}`
    );
    setCities(response.data);
  }
                          ...
                          <div className="form-group">
                            ...
                            >
                              ...
                              {countries.map((country) => (
                                <option
                                  key={country.cnCountryID}
                                  value={country.cnCountryID}
                                >
                                  {country.cnCountryName}
                                </option>
                              ))}
                            </select>
                          </div>
                          ...
                          <tbody>
                            {locations.map((loc) => (
                              <tr key={loc.cnCountryID}>
                                ...
                                >
                                  {loc.activeStatus ? "Active" : "Inactive"}
                                </td>
                                <td>
